...
import my_getdist
from my_getdist import chains, types, covmat, ParamInfo, IniFile, ParamNames
from my_getdist.densities import Density1D, Density2D, DensityND
from my_getdist.densities import getContourLevels as getOtherContourLevels
from my_getdist.chains import Chains, chainFiles, lastModified
from my_getdist.convolve import convolve1D, convolve2D
import my_getdist.kde_bandwidth as kde
...
def loadMCSamples(file_root, ini=None, jobItem=None, no_cache=False, settings={}, dist_settings={}):
    ...
    `analysis_defaults.ini <http://my_getdist.readthedocs.org/en/latest/analysis_settings.html>`_.
    ...
    path = my_getdist.cache_dir or path
...
def loadCobayaSamples(info, collections, name_tag=None,
    ...
    from my_getdist.yaml_format_tools import _p_label, _p_renames, _weight, _minuslogpost
    from my_getdist.yaml_format_tools import get_info_params, get_range, is_derived_param
...
class MCSamples(Chains):
    ...
    def __init__(self, root=None, jobItem=None, ini=None, settings=None, ranges=None,
        ...
        self.plot_output = my_getdist.default_plot_output
        self.out_dir = ""
    ...
    def updateSettings(self, settings=None, ini=None, doUpdate=True):
        ...
        if not ini: ini = IniFile(my_getdist.default_my_getdist_settings)
        if settings:
    ...
    def _WritePlotFile(self, filename, subplot_size, text, tag, ext=None):
        ...
        """
        with open(filename, 'w') as f:
            f.write("import my_getdist.plots as plots, os\n")
